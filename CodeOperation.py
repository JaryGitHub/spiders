...
d = {'Id': 'X/html/body//div[@class="title"]/p[@class="gray9"]/span[@class="mr10"]',
     'Date': 'R\d{4}\W\d{2}\W\d{2}\s{2}', 'UnitPrice': 'R\d+元/㎡', 'ApartmentLayout': 'R\d室\d厅\d厨\d卫',
     'Total': 'X/html/body/div//dl/dt[@class="gray6 zongjia1"]/span[@class="red20b"]',
     'Area': 'X/html/body/div//dl/dd/span[@class="black "]',
     'ResidentialQuarters': 'X/html/body//dl/dt/a[@id="agantesfxq_B02_08"]', 'Age': 'X/html/body//dl/dd',
     'Floor': 'X/html/body//dl/dd', 'Decoration': 'X/html/body//dl/dd',
     'Address': 'R<dt><span class="gray6">楼盘名称：</span>(.*?)  &nbsp;&nbsp;', 'url': 'X//a//@href'}
q = ControlThread()
...
q.add_analysis({'^.*(fang)\.com\/(?<!chushou)$': {'url': 'X//a//@href'}, '\S+fang\S+(chushou)\S+\d+\S+': {
    'Id': 'X/html/body//div[@class="title"]/p[@class="gray9"]/span[@class="mr10"]', 'Date': 'R\d{4}\W\d{2}\W\d{2}\s{2}',
    'UnitPrice': 'R\d+元/㎡', 'ApartmentLayout': 'R\d室\d厅\d厨\d卫',
    'Total': 'X/html/body/div//dl/dt[@class="gray6 zongjia1"]/span[@class="red20b"]',
    'Area': 'X/html/body/div//dl/dd/span[@class="black "]',
    'ResidentialQuarters': 'X/html/body//dl/dt/a[@id="agantesfxq_B02_08"]', 'Age': 'X/html/body//dl/dd',
    'Floor': 'X/html/body//dl/dd', 'Decoration': 'X/html/body//dl/dd',
    'Address': 'R<dt><span class="gray6">楼盘名称：</span>(.*?)  &nbsp;&nbsp;', 'url': 'X//a//@href'},
                '\S+fang\S+house\S+i\d\d\S+': {'url': 'X//a//@href'}})
